          ...
          <div className="text-center space-y-4">
            <div className="flex justify-center">
              <img 
                ...
                style={{ filter: 'drop-shadow(0 0 40px hsl(var(--submito-cyan) / 0.6))' }}
              />
            </div>
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">
                Welcome to Submito!
              </h1>
              <p className="text-muted-foreground mt-2 text-sm">
                Create your organization to manage your academic institution
              </p>
            </div>
          </div>
